...
public:
    ...
    DualArmController() : Node("my_env_mujoco_control")
    {
        ...
        RCLCPP_INFO(this->get_logger(), "my_env_mujoco_control node initialized");
    }
